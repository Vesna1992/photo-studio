<?php $page = 'about'; include('shared/header.php');?>
<!-- about -->
<section class="about">
    <article class="text">
...
<section class="team container">
    <h2>Our team</h2>
    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Fugiat a minus esse fuga! Asperiores, ipsa.</p>
    <article>
        <div>
            <img src="img/team1.jpg" alt="person image">
            <div class="text">
                <h3>Lee Dorian</h3>
                <h4>CEO</h4>
        ...
        <div>
            <img src="img/team3.jpg" alt="person image">
            <div class="text">
                <h3>Ann Parker</h3>
                <h4>Photographer</h4>
                <a href=""><i class="fab fa-facebook-square"></i></a>
